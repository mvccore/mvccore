...
interface IRoute
{
	 ...
	 * @param array			$constraints		Optional, params regular expression constraints for regular expression match function if no `"match"` record in configuration array as first argument defined.
